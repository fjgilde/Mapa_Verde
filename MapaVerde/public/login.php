...
<body>
    ...
    const profilePictureUrl = "<?php echo isset($_SESSION['profile_picture']) ? $_SESSION['profile_picture'] : ''; ?>";

    if (isLoggedIn) {
        profileContainer.innerHTML = `
            <img src="${profilePictureUrl}" alt="Foto de perfil" id="profile-picture">
        `;
    }
 });
    </script>
